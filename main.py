...
# plt.show(block=True)
random_array = p2p_positions_gen_fcn(low=1, high=2, number_of_positions=5, duration_of_each_position=1, timestep=.005)

plt.plot(range(random_array.shape[0]),random_array)
plt.show(block=True)
