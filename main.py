...
np.random.seed(0)
experiments_switch = np.ones(11,) # sets which experiments should run
...
[errors_all, trial_number] = pickle.load(open("results/P_I/feedback_errors_P_I_tmp.sav", 'rb')) # loading the results with only P
