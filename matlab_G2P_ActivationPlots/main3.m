...
if which_plot==10
    ...
    addr_prefix='/Users/alimarjaninejad/Documents/MATLAB/G2P_ActivationPlots/reinforcement_with_adaptation_10-20190711T000402Z-001/reinforcement_with_adaptation_10/';
    file_name='matfile_experimentid_reinforcement_with_adaptation_10_attempt_';
    ...
    for jj = [1:3 76:78]
        ...
        Acts2plot{kk} = [interp(run1_A_all_pred(:,1),interpolation_rate) interp(run1_A_all_pred(:,2),interpolation_rate) interp(run1_A_all_pred(:,3),interpolation_rate)];
    end
    start_to_plot = 80*interpolation_rate;
    end_the_plot = 160*interpolation_rate;
elseif which_plot==9
        start_attempt2plot=1;
...
pause()
if sbs==1
    comet3n_e_sbs(src, 'speed', 10, 'taillength', 100*interpolation_rate, 'tailwidth', 2)
else
    comet3n_e(src, 'speed', 10, 'taillength', 100*interpolation_rate, 'tailwidth', 2)
end