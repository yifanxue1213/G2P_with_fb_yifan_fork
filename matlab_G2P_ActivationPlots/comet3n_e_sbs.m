function comet3n_e_sbs( src, varargin )
...
figure(1);
if tmp1==1
    figure('Renderer', 'painters', 'Position', [10 10 450 600])
    tmp1=0;
end
...
%view([45 45])
view([55 55])
xlabel('motor 1 activation')
set(get(gca,'xlabel'),'rotation',-55)
ylabel('motor 2 activation')
set(get(gca,'ylabel'),'rotation',33)
zlabel('motor 3 activation')
